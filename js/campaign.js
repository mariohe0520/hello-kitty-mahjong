...
const Campaign = (() => {
  ...
  const LEVELS = [
    ...
    { id: 2, chapter: 1, name: '顺子的奥秘', difficulty: 1,
      desc: '用至少2个顺子胡牌', goal: { type: 'win' }, reward: { coins: 120, exp: 60 },
    ...
    { id: 3, chapter: 1, name: '碰碰乐', difficulty: 1,
      desc: '在一局中碰牌至少1次并获胜', goal: { type: 'win' }, reward: { coins: 150, exp: 70 },
    ...
    { id: 32, chapter: 4, name: '速战速决', difficulty: 5, desc: '赢得比赛', goal: { type: 'win' },
